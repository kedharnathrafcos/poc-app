...
const StepOne = (props) => {
  const goForword = () => {
    props.goForword(2, "stepOne", {cource: true, file: true});
  };
  return (
    <div>
      <div>
        <Grid container className="containerDiv">
          ...
          <Grid xs={12}>
            <p className="subHeding">
              We`ll upload it, pull all the right information and you will have access to
              it any time.
            </p>
          </Grid>
          <Grid xs={12}>
          ...
          <Grid container>
            <Grid item xs={12}>
              <p className="entitle">
                We `ve successfully uploaded your document. We`ll apply everything we can
                in the next step
              </p>
            </Grid>
          </Grid>
